...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String video_path = "C:\\Users\\Administrator\\Videos\\cyber\\1.mkv";
    String mp4_name = "1.mp4";
    String mp4folder_path = "C:\\Users\\Administrator\\Videos\\cyber\\";

    public Mp4VideoUtil(String ffmpeg_path) {
        super(ffmpeg_path);
    }
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        Mp4VideoUtil videoUtil = new Mp4VideoUtil("C:\\Program Files\\ffmpeg-master-latest-win64-gpl\\bin\\ffmpeg.exe");
        //开始视频转换，成功将返回success
